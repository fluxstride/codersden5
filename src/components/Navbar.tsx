...
const Navbar = () => {
  ...
  return (
    <div
      className={` text-main-text bg-white fixed w-full z-50 transition-all duration-500 ease-in-out ${
        isScrolled ? "navbar-scroll" : ""
      }`}
    >
      <div className="flex justify-between items-center text-center w-full h-20 p-4 xl:mx-auto xl:max-w-7xl">
        <div>
          <Link href="/">
